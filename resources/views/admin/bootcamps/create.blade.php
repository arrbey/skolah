...
@section('page-header')
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500">Isi form di bawah untuk membuat bootcamp atau webinar baru</p>
        </div>
    </div>
@endsection

@section('content')
<form method="POST" action="{{ route('admin.bootcamps.store') }}" enctype="multipart/form-data" class="space-y-6">
    @csrf
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6 space-y-5">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="6" required
                              class="tinymce w-full rounded-xl border border-gray-300 px-4 py-2.5 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500">{{ old('description') }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="platform" name="platform" value="{{ old('platform') }}" placeholder="Contoh: Zoom / Jakarta"
                               class="w-full rounded-xl border border-gray-300 px-4 py-2.5 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6 space-y-5">
                ...
                <div>
                    ...
                    <input type="number" id="max_participants" name="max_participants" min="0"
                           value="{{ old('max_participants', 0) }}" placeholder="0 = unlimited"
                           class="w-full rounded-xl border border-gray-300 px-4 py-2.5 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                </div>
            </div>

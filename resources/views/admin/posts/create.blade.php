...
@section('page-header')
    <div class="flex items-center gap-3">
        ...
        <h1 class="text-lg font-bold text-gray-900">Tulis Artikel Baru</h1>
    </div>
@endsection
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm space-y-6">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="category" required
                        ...
                        <option value="Update Platform">Update Platform</option>
                    </select>
                </div>
                ...
                <div class="flex items-center justify-center w-full">
                    <label class="flex flex-col items-center justify-center w-full h-48 border-2 border-gray-300 border-dashed rounded-2xl cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors overflow-hidden relative">
                        <div id="preview-container" class="flex flex-col items-center justify-center pt-5 pb-6">
                            ...
                            <p class="mb-2 text-sm text-gray-500 font-semibold">Klik untuk upload gambar</p>
            ...
            <div>
                ...
                <textarea name="content" rows="15" required
                          ...
                          class="tinymce w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary-500 focus:border-transparent font-mono text-sm">{{ old('content') }}</textarea>

...
@section('content')
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-4 mb-6">
        <form method="GET" class="flex flex-wrap items-center gap-3">
            ...
            <select name="courier" class="rounded-xl border border-gray-300 px-4 py-2 text-sm">
            ...
            @if(request()->hasAny(['search','status','courier']))
                <a href="{{ route('admin.book-orders.index') }}" class="text-sm text-gray-500 hover:text-gray-700">Reset</a>
            @endif
        </form>
    </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-4 py-3">
                            @if($bo->courier)
                                <span class="inline-block px-2 py-0.5 rounded text-xs font-bold
                                    ...
                                    {{ strtoupper($bo->courier) === 'JNT' ? 'J&T' : strtoupper($bo->courier) }}
                                </span>
                            @else
                        ...
                        <td class="px-4 py-3">
                            <a href="{{ route('admin.book-orders.show', $bo) }}"
                    ...
                    <tr>
                        <td colspan="5" class="px-4 py-12 text-center text-gray-400 text-sm">
                            Tidak ada data pengiriman buku.
                        </td>
                    </tr>
                    @endforelse
                </tbody>

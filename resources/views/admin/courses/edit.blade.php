...
@section('page-header')
    <div class="flex items-center justify-between w-full">
        ...
        <div class="flex items-center gap-2">
             {{-- Link to curriculum management (placeholder for now, will reuse instructor view or create admin one) --}}
             <a href="{{ route('instructor.courses.edit', $course) }}#curriculum" 
                class="px-4 py-2 rounded-xl bg-secondary-600 text-white text-sm font-bold hover:bg-secondary-700 transition-all shadow-sm">
                📚 Kelola Kurikulum & Video
             </a>
        </div>
    </div>
@endsection
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6 space-y-5">
                ...
                <div class="pt-4 border-t border-gray-100">
                    ...
                    <div class="relative">
                        ...
                        <input type="url" id="trailer_url" name="trailer_url" value="{{ old('trailer_url', $course->trailer_url) }}"
